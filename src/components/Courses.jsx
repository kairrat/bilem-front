...
const Courses = () => {
    ...
    const sortedCategories = category.sort((a, b) => b.coursesQuantity - a.coursesQuantity);

    const limitedCategories = sortedCategories.slice(0, 5);

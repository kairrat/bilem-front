...
const Register = () => {
  ...
  return (
    <div>
        <div class="py-6">
  <div class="flex bg-white rounded-lg  overflow-hidden mx-auto max-w-full lg:max-w-6xl">
  <div className="flex justify-center items-center lg:w-1/2 bg-cover" style={{backgroundImage: `url(${logo})`}}></div>
        ...
        <div class="w-full p-8 lg:w-1/2 mt-20">
            <h2 class="text-2xl font-semibold text-gray-700 text-center">{t('welcome')}</h2>
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <span class="text-xs text-gray-500 uppercase">или</span>
                <span class="border-b w-1/3 md:w-1/3"></span>
            ...
            <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                ...
                <h1 class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">{t('register_google')}</h1>
            </a>
